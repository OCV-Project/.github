...
# Проекты по ВВИТ на С++ и QT для открытого урока
...
> [!IMPORTANT]
> Все материалы, представленные здесь, используются только в учебных целях. Все совпадения с чьими-либо проектами случайны. Коммерческе использование проектов, представленных здесь, запрещено.
